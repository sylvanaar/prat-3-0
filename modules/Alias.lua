...
L:AddLocale("deDE", {
	["module_name"] = "Alias",
	["module_desc"] = "Fügt das Chatkommando /alias hinzu, das dazu benutzt werden kann selbst definierte Wörter für Chatkommandos zu verwenden. Ähnlich wie es das UNIX Alias Kommando tut.",
	["add"] = "add",
	["add an alias"] = "Füge ein Alias Kommando hinzu.",
	['<command>[ <value>] - alias <command> to be executed as <value>, or return the value of the currently defined alias for <command> if <command> has not been assigned a value. eg: "/alias /examplehello /say hello there" - typing "/examplehello" will now cause your character to say "hello there"; "/alias examplehello" - \s "/examplehello is aliased to /say hello there" (cmd aliases: /addalias)'] = '<Kommando>[ <Wert>] - Alias <Kommando>, das als <Wert> ausgeführt werden soll, oder den Wert des Aktuell definierten Alias für <Kommando> wenn <Kommando> noch kein Wert zugewiesen wurde. z. B.: "/alias /examplehello /say hello there" - Eingeben von "/examplehello" wird deinen Charakter nun "hello there" sagen lassen; "/alias examplehello" - gibt "/examplehello ist ein Alias für /say hello there" (Kommando Alias: /addalias) aus',
	["unalias"] = "unalias",
	["remove an alias"] = "Entfernt einen Alias",
	['<alias> - remove the alias <alias> (cmd aliases: /delalias, /remalias)'] = "<Alias> - Entfernt den Alias <Alias> (Kommando Alias: /delalias, /remalias)",
	["listaliases"] = "listaliases",
	["list all aliases"] = "Alle Aliase Auflisten",
	['findaliases'] = "findaliases",
	['find aliases matching a given search term'] = "Findet Aliase, die auf einen angegebenen Suchbegriff zutreffen",
	['<keyword> - finds all aliases matching <keyword> (cmd aliases: /findalias)'] = "<Suchwort> - Findet alle Aliase die auf <Suchwort> zutreffen (Kommando Alias: /findaliases)",
	['verbose'] = "verbose",
	['Display extra information in the chat frame when commands are dealiased'] = "Zeigt Zusatzinfos im Chatframe wenn Aliase entfernt werden",
	['inline'] = "inline",
	['Expand aliases as you are typing'] = "Vervollständigt Aliase beim Schreiben",
	["Options for altering the behaviour of Alias"] = "Optionen zum Verändern des Verhalten der Aliase",
	['Options'] = "Optionen",
	['noclobber'] = "moclobber",
	["Don't overwrite existing aliases when using /addalias"] = "Überschreibe keine Exsistierenden Aliase durch /addalias",
	[' - list all aliases; supply <keyword> to search for matching aliases (cmd aliases: /listallaliases)'] = " - Auflistung aller Aliase; Bei Angabe von <Suchwort> wird Nach Treffenden Aliasen gesucht (Kommando Alias: /listallaliases)",
	["%s() called with nil argument!"] = "%s() mit nil Argument aufgerufen!",
	["%s() called with blank string!"] = "%s() mit Leerem String aufgerufen!",
	['refusing to alias "/%s" to anything in the interests of Not Buggering Everything Up'] = 'Aliasen von "/%s" verweigert, um eventuelle Schäden zu Vermeiden',
	['noclobber set - skipping new alias: /%s already expands to /%s'] = "noclobber gesetzt - Überspringe Alias: /%s ist schon /%s",
	['overwriting existing alias "/%s" (was aliased to "/%s")'] = 'Überschreibe Exsistierenden Alias "/%s" (war vorher "/%s")',
	["/%s aliased to: /%s"] = "/%s ist: /%s",
	['alias "/%s" does not exist'] = 'Alias "/%s" existiert nicht',
	['deleting alias "/%s" (previously aliased as "/%s")'] = 'Entferne Alias "/%s" (war "/%s")',
	['tried to show value for alias "%s" but undefined in module.Aliases!'] = 'Versuchte Aliaswert für "%s" zu zeigen, ist aber nicht in module.Aliases definiert!',
	['/%s aliased to "/%s"'] = '/%s ist "/%s"',
	["No aliases have been defined"] = "Keine Aliase definiert",
	['There is no alias current defined for "%s"'] = 'Momentan ist kein Alias für "%s" definiert',
	['infinite loop detected for alias /%s - ignoring'] = "Endlosschleife für Alias /%s entdeckt - ignoriere",
	['dealiasing command /%s to /%s'] = "Entferne Aliaskommando /%s zu %s",
	['matching aliases found: %d'] = "zutreffende Aliase gefunden: %d",
	['total aliases: %d'] = "Aliase Gesamt: %d",
	["warnUser() called with nil argument!"] = "warnUser() mit nil Argument aufgerufen!",
