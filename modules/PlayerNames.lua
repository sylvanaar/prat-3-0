...
Prat:AddModuleToLoad(function()
  ...
  L:AddLocale("koKR",
  {
	...
	["Keep Info"] = "길드원 정보 저장",
	["Keep Lots Of Info"] = "모든 유저 정보 저장",
	["Keep player information between session, but limit it to friends and guild members."] = "친구와 길드원에 대한 정보를 저장합니다.",
	["Keep player information between session for all players except cross-server players"] = "모든 유저에 대한 정보를 저장합니다. (다른 서버는 제외)",
	["Let TasteTheNaimbow set the common color for unknown player names."] = "알 수 없는 플레이어 이름에 대한 색깔로 TasteTheNaimBow 애드온의 설정을 사용합니다.",
	["Level Color Mode"] = "레벨 색깔 설정",
	linkifycommon_desc = "일반 메시지 링크",
	linkifycommon_name = "일반 메시지 링크",
	["No additional coloring"] = "색상 사용하지 않음",
	None = "없음",
	...
	["Tab completion : "] = "탭 완성 :",
	["Toggle group invites by alt-clicking hyperlinked keywords like 'invite'."] = "'초대' 같은 하이퍼링크 단어 Alt-클릭으로 초대하기",
	...
	["Toggle showing the raid target icon which is currently on the player."] = "플레이어에게 지정된 전술 아이콘 표시",
	...
	["Unknown Common Color From TasteTheNaimbow"] = "TasteTheNaimbow 로부터 알 수 없는 일반 색상",
