...
L:AddLocale("ruRU", {
    ...
    ["Set Alpha"] = "Прозрачность",
    ["Set the alpha of the editbox."] = "Установка прозрачности поля ввода.",
    ["Set Position"] = "Позиция",
    ["Set the position of the editbox."] = "Установка позиции поля ввода.",
    ["Hide Border"] = "Скрыть края",
    ["Hide the border around the edit box."] = "Скрыть края вокруг поля ввода.",
    ["Set Width (NB: only enabled if the editbox is undocked)"] = "Ширина (работает только если поле ввода отстыковоно)",
    ["Set the width of the editbox."] = "Ширина поля ввода",
    ["Lock Position"] = "Закрепить позицию",
    ["Lock editbox position if undocked."] = "Закрепить позицию поля ввода если не закреплена.",
    ["Enable Arrowkeys"] = "Разрешить кнопки перемещения",
    ["Enable using arrowkeys in editbox without the alt key."] = "Включить использование кнопок перемещения в поле ввода без использования клавиши alt.",
    ["Autohide"] = "Авто-скрыть",
    ["Hide the edit box after you have pressed enter."] = "Скрыть поле ввода после того как вы нажмёте клавишу ввод.",
    ["Clickable"] = "Кликабельное",
    ["Click the edit box to open it up for editing. Only available if Autohide is disabled."] = "Кликнув по полю ввода, открывает его для ввода. Доступно только если отключено авто-скрытие.",
	["Top"] = "Вверху",
	["Bottom"] = "Вниху",
	["Undocked"] = "Отстыковать",
	['Set the frame strata of the editbox.'] = "Установите слой фрейма поля ввода.",
	['Set Strata'] = "Слой",
	['DIALOG'] = true,
	['HIGH'] = true,
	['MEDIUM'] = true,
	...
	['BACKGROUND'] = true,
	['Texture'] = "Текстура",
	['Set the texture of the chat edit box'] = "Установка текстуры для поля ввода чата.",
	['Bar colour'] = "Цвет фона",
	['Set the edit box background colour'] = "Установка цвета фона поля ввода.",
	['Border width'] = "Ширина краёв",
	["Set the width of the edit box's border"] = "Установка ширины краёв поля ввода.",
	['Border colour'] = "Цвет краёв",
	['Set the edit box border colour'] = "Установка цвета краёв поля ввода.",
	['Padding'] = "Заполнение",
	["Set the amount of padding inside the edit box"] = "Установка величину заполнения внутри поля ввода",
})
